            ...
            <center>
                <form method="post" action="buyNow.php?pid=<?= $pid; ?>" style="border: 1px solid black; padding: 15px;">
                    ...
                    <div class="row uniform">
                        ...
                        <div class="8u 12u$(xsmall)">
                            <input type="text" name="CardType" id="CardType" value="" placeholder="Card Type" required/>
                        </div>
                        <div class="8u 12u$(xsmall)">
                            <input type="text" name="NameCard" id="NameCard" value="" placeholder="Name On Card" required/>
                        </div>
                        <div class="8u 12u$(xsmall)">
                            <input type="text" name="CardNo" id="CardNo" value="" placeholder="1111 2222 3333 4444" required/>
                        </div>
                        <div class="8u 12u$(xsmall)">
                            <input type="password" name="CVV" id="CVV" value="" placeholder="CVV" required/>
                        </div>
