	...
	<body>
		...
		<!-- One -->
			...
			<section id="one" class="wrapper style1 align-center">
				...
				<div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black; float: left;">
								  <option value="" style="color: black;"> Per /-</option>
								  <option value="kg" style="color: black;">Kg</option>
								  <option value="dozen" style="color: black;">Dozen</option>
